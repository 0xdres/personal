...
<div className="border-l-4 border-accent bg-accent/8 p-6 my-8 rounded-r-xl">
  ...
  <p className="text-foreground/75 text-sm m-0 leading-relaxed">
    ...
    El objetivo final era permitir a los atacantes <strong>ejecutar código arbitrario con privilegios de administrador en prácticamente cualquier servidor Linux moderno en el mundo</strong>, sin dejar rastro en los registros (logs).
  </p>
</div>
