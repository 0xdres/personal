...
description: Uno de tantos métodos disponibles para instalar alguna aplicación en Arch
...
![Instalar Arch Linux](../../../assets/images/post-covers/instalar-programas-en-arch-linux.jpg)
