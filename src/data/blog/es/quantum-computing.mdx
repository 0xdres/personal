...
description: La computación cuántica es una rama de la informática que se centra en el estudio de cómo utilizar sistemas cuánticos para procesar información.
...
> A diferencia de los bits clásicos, los qubits pueden estar en múltiples estados a la vez, lo que aumenta drásticamente la capacidad de procesamiento.
> Aunque es prometedora para resolver problemas complejos en diversos campos, enfrenta desafíos significativos en su desarrollo y programación.

---

![Computación cuántica](../../../assets/images/post-covers/computacion-cuantica.webp)
